...
post2021_latin_changedetection = Path("/mnt/hddarchive.nfs/output/projects/S14AMA")
...
for tile_item in post_2021_latin_tiles:

    tile_input_raster = post2021_latin_changedetection.joinpath(tile_item, f"{tile_item}_masked_combined_filtered_detection_sieved.tif")
    if tile_input_raster.exists():
        mosaic_input_list.append(tile_input_raster)
print(f"creating {len(mosaic_input_list)} - {mosaic_input_list}")


output_raster = Path("/mnt/hddarchive.nfs/amazonas_dir/work_dir/portal_data/post_2021/overall_withlatin_treecoverchange_mosaic.tif")
